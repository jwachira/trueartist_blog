...
/***************************************************************************/
	...
	function themify_img_settings($data=array()){
		...
		$options = array(
			array("value" => "c", "name" => "Center"),
			array("value" => "t", "name" => "Top"),
			array("value" => "tr",	"name" => "Top Right"),
			array("value" => "tl",	"name" => "Top Left"),
			array("value" => "b",	"name" => "Bottom"),
			array("value" => "br",	"name" => "Bottom Right"),
			array("value" => "bl",	"name" => "Bottom Left"),
			array("value" => "l",	"name" => "Left"),
			array("value" => "r",	"name" => "Right")
		);
...
/***************************************************************************/	
	...
	function themify_background_image($data=array()){	
		...
		$output .= '<p class="background_image">
						...
						<input type="checkbox" name="styling-'.$data['category'].'-'.$data['title'].'-background_image-value-none" '.$none_checked.' /> No BG image<br /> 
						<span class="pushlabel" style="display:block;">
