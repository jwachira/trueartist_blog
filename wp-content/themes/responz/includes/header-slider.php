					...
					if(themify_check('setting-header_slider_images_'.$option.'_image')){
						echo '<li>';
							if(themify_check('setting-header_slider_images_'.$option.'_link')){ 
								...
								echo $title;
								themify_image("src=".$image."&setting=slider&w=222&h=140&before=<a href='".urlencode($link)."' title='".urlencode($link)."'>&after=</a>&alt=".urlencode($link)."&class=feature-img");
								
							} else {
								
								$image = themify_get('setting-header_slider_images_'.$option.'_image');
								themify_image("src=".$image."&setting=slider&w=222&h=140&alt=".$image."&class=feature-img");
							}
						echo '</li>';
					}
				}
                    	...
                    	<li>
							...
							<div class="slide-feature-image">
								<a href='<?php echo $link; ?>'>
									<?php themify_image("field_name=feature_image, post_image, image, wp_thumb&ignore=true&setting=slider&w=222&h=140"); ?>
								</a>	
							</div>
							<!-- /.slide-feature-image -->
